function Contact() {
  return (
    <>
      ...
      <div className="bg-[hsl(0,0%,7%)] mx-auto justify-center my-4 p-5 text-center rounded-2xl">
        <a
          href="mailto:pugazhendhiexplorer@gmail.com"
          className="contentRevealAnimation justify-start flex gap-2 max-w-[260px] mx-auto"
        >
